...
import EditorUploader from "./media/views/uploader/editor";
 ...
 */
export const coerce = function ( attrs, key ) {
...
export const string = {
	 ...
	 */
    //TODO::wp.media.view.settings.defaultProps;
	 ...
	 */
     //TODO::wp.media.string, wp.media.view.settings.embedExts, wp.shortcode, 
	 ...
	 * @return {string}
	 */
    //TODO::wp.media.string, wp.html, wp.shortcode, 
 ...
 */
export const collection = function(attributes) {
	var collections = {};
	...
	return _.extend(/** @lends wp.media.collection.prototype */{
		 ...
		 * @return {wp.shortcode}
		 */
         //TODO::wp.shortcode, wp.media.model.Attachments
		 ...
		 */
         //TODO::wp.shortcode, wp.media.model.Selection, wp.media
...
//TODO:: wp.media.view.settings.post
export const _galleryDefaults = {
	itemtag: 'dl',
	icontag: 'dt',
	captiontag: 'dd',
	columns: '3',
...
export const galleryDefaults = _galleryDefaults;

export const gallery = new collection({
	tag: 'gallery',
	type : 'image',
	editTitle : l10n.editGalleryTitle,
	defaults : galleryDefaults,

	setDefaults: function( attrs ) {
		var self = this, changed = ! _.isEqual( galleryDefaults, _galleryDefaults );
		_.each( this.defaults, function( value, key ) {
			attrs[ key ] = self.coerce( attrs, key );
			if ( value === attrs[ key ] && ( ! changed || value === _galleryDefaults[ key ] ) ) {
				delete attrs[ key ];
			}
		} );
		return attrs;
...
export const editor = {
	...
	send: {
		...
		init: function() {
			$(document.body)
				.on( 'click.add-media-button', '.insert-media', function( event ) {
					...
					if ( elem.hasClass( 'gallery' ) ) {
						...
						options.title = l10n.createGalleryTitle;
					}
			...
			new EditorUploader().render();
		}
	};

_.bindAll( editor, 'open' );
$( editor.init );
