 ...
 */
	 ...
	 *
	 * @since 3.5.0
	 * @since 3.6.0 Moved wp.media.Views to wpBackbone.Subviews.
	 *
	 * @memberOf wpBackbone
	 *
	 * @class
	 *
	 * @param {wpBackbone.View} view  The main view.
	 * @param {Array|Object}     views The subviews for the main view.
	 */
	wpBackbone.Subviews = function( view, views ) {
		this.view = view;
		this._views = _.isArray( views ) ? { '': views } : views || {};
	};

	wpBackbone.Subviews.extend = Backbone.Model.extend;

	_.extend( wpBackbone.Subviews.prototype, {
		/**
		 ...
		 *
		 * @return {wpBackbone.Subviews} The current Subviews instance.
		 */
		set: function( selector, views, options ) {
			...
			_.each( views, function( subview ) {
				var constructor = subview.Views || wpBackbone.Subviews,
	...
	wpBackbone.View = Backbone.View.extend({

		// The constructor for the `Views` manager.
		Subviews: wpBackbone.Subviews,
		 ...
		 *
		 * @since 3.5.0
		 * @since 3.6.0 Moved wp.media.View to wpBackbone.View
		 *
		 * @constructs
		 ...
		 * @since 3.5.0
		 *
		 * @return {wpBackbone.View} The current instance of the view.
		 */
		render: function() {
			var options;
